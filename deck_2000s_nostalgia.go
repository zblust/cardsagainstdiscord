...
func init() {
	pack := &CardPack{
		...
		Description: "CAH: 2000s Nostalgia Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `_? That's a no from me, dawg.`},
			&PromptCard{Prompt: `16 people. 39 days of _. One Survivor.`},
			&PromptCard{Prompt: `I couldn't help but wonder. Was "having it all" an unattainable myth? Was the secret to a truly happy life just _?`},
			&PromptCard{Prompt: `Oh my god! _ killed Kenny!`},
			&PromptCard{Prompt: `Oops! I did it again. I played with _.`},
		},
