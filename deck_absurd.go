...
func init() {
	pack := &CardPack{
		...
		Description: "Absurd Box Expansion pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `Ain't it nifty? Barb and Bob hit 50! So get off your ass and raise a glass to 50 years of _.`},
			&PromptCard{Prompt: `Duuuuuuude. You have got to go to space. _ is awesome in space.`},
			&PromptCard{Prompt: `Five,
four,
three,
two,
one....
_!`},
			&PromptCard{Prompt: `For hunting in the King's forest, I hereby sentence you to death by _.`},
			&PromptCard{Prompt: `Give me ten good men and 48 hours. I'll get you _.`},
			&PromptCard{Prompt: `Goldfinger!
He's the man,
the man with _.`},
			&PromptCard{Prompt: `Goodbye, _, hello _!`},
			&PromptCard{Prompt: `Here's a little something I learned in business school: The customer is always _.`},
			&PromptCard{Prompt: `Hey, honey.
For the bedroom, were you thinking, "Robin's Egg Blue" or _Pink?"`},
			&PromptCard{Prompt: `I hate this job.
I hate this place.
Most of all, I hate _.
I quit.`},
			&PromptCard{Prompt: `I have solved politics.
My solution is _.`},
			&PromptCard{Prompt: `I so drunk I _.`},
			&PromptCard{Prompt: `I swear to God I'm gonna murder my husband if he doesn't shut the fuck up about _.`},
			&PromptCard{Prompt: `In bookstores now: "From _ to _: A memoir."`},
			&PromptCard{Prompt: `In Radiohead's new single, Thom Yorke repeats the phrase "_" dozens of times over a skittering drum beat.`},
			&PromptCard{Prompt: `It's finally happening! I'm finally doing it! Yes! It's time for _!`},
			&PromptCard{Prompt: `It's late at night. You're in bed with your lover, Patrick Stewart. He leans over with a twinkle in his eye and asks "How about _?"`},
			&PromptCard{Prompt: `It's the 21st century.
A woman shouldn't have to apologize for _.`},
			&PromptCard{Prompt: `Ladies and gentlemen, I propose a two-pronged plan. The first prong will be _, and the second prong will be _.`},
			&PromptCard{Prompt: `Live from Universal Studios, it's America's favorite game show! "_ or _?"`},
			&PromptCard{Prompt: `Millions of copies sold! Donald Trump's "The Art of _."`},
			&PromptCard{Prompt: `New at TGI Fridays! It's what you've been waiting for: The _ Burger.`},
			&PromptCard{Prompt: `Oh no!
Here it comes!
Ohhhhh god!
It's _.`},
			&PromptCard{Prompt: `Oh you haaaaaaave to see this new documentary on Netflix. I don't want to give anything away, but let's just say it will change the way you look at _.`},
			&PromptCard{Prompt: `Oh, the weather outside is frightful. But _ is so delightful.`},
			&PromptCard{Prompt: `One, two, three and to the four, Snoop Doggy Dogg and Dr. Dre is _.`},
			&PromptCard{Prompt: `Personal foul: _. 15-yard penalty. Automatic first down.`},
			&PromptCard{Prompt: `Rub a dub dub, _ in a tub!`},
			&PromptCard{Prompt: `Say it loud! I'm _ and I'm proud!`},
			&PromptCard{Prompt: `Seriously guys, there's nothing funny about _.`},
			&PromptCard{Prompt: `Sweetheart, you and your sister escel in different ways. She's got her violin, and you've got _.`},
			&PromptCard{Prompt: `That's bullshit! They can't fire me for _!`},
			&PromptCard{Prompt: `The sequel is here! Get Ready for _2: _.`},
			&PromptCard{Prompt: `Times have changed, girlfriend. If you want to meet people in New York, you got to be down for _.`},
			&PromptCard{Prompt: `Unfortunately, no one can be told what _ is. You have to experience it for yourself.`},
			&PromptCard{Prompt: `What has my life become? I'm jerking off to a video called "co-ed absolutely destroyed by _."`},
			&PromptCard{Prompt: `What sounds great after four margaritas?`},
			&PromptCard{Prompt: `What's hot, smelly, and about to die?`},
			&PromptCard{Prompt: `What's secretly a Russian plot to destabilize the West?`},
			&PromptCard{Prompt: `What's up, YouTube?
User DanTheMan wanted to see _, so here we go.`},
			&PromptCard{Prompt: `Why did the chicken cross the road?`},
			&PromptCard{Prompt: `Why my mustache smell so bad?`},
			&PromptCard{Prompt: `Yeah that's so hot.
I'm so close.
Talk about _ again!
OH I'M CUMMING!`},
			&PromptCard{Prompt: `You can call me David Copperfield, because I'm about to make _ disappear.`},
			&PromptCard{Prompt: `You city folk would never understand the quiet dignity of _.`},
		},
