...
func init() {
	pack := &CardPack{
		Name:        "CAH: Ass Pack",
		Description: "CAH: Ass Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `I like _ and I cannot lie!`},
			&PromptCard{Prompt: `My anaconda don't want none unless you got _, hun.`},
			&PromptCard{Prompt: `My homeboys tried to warn me, but _ makes me so horny.`},
		},
