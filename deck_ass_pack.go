...
func init() {
	pack := &CardPack{
		Name:        "ass",
		Description: "CAH: Ass Pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `I like %s and I cannot lie!`},
			&PromptCard{Prompt: `My anaconda don't want none unless you got %s, hun.`},
			&PromptCard{Prompt: `My homeboys tried to warn me, but %s makes me so horny.`},
		},
