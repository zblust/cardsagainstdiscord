...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `To become a true Yanomamo warrior, you must prove that you can withstand %s without crying out.`},
			&PromptCard{Prompt: `You guys, I saw this crazy movie last night. It opens on %s, and then there's some stuff about %s, and then it ends with %s.`},
		},
