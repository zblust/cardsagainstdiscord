...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `%s is a sure sign of mankind's decline.`},
			...
			&PromptCard{Prompt: `%s? Oh yeah. There's porn about that.`},
			...
			&PromptCard{Prompt: `%s. The best way to spice up your sex life.`},
			...
			&PromptCard{Prompt: `After Hurricane Katrina, Sean Penn brought %s to the people of New Orleans.`},
...
I think I am, B2: it's %s time!`},
			&PromptCard{Prompt: `As my New Year's resolution, I vow to give up %s.`},
			&PromptCard{Prompt: `As the mom of five rambunctious boys, I'm no stranger to %s.`},
			...
			&PromptCard{Prompt: `Brought to you by Molson Canadian, the Official Beer of %s.`},
			&PromptCard{Prompt: `Brought to you by XXXX Gold, the Official Beer of %s.`},
			...
			&PromptCard{Prompt: `Dude, do not go in that washroom. There's %s in there.`},
...
Open the doors
And there is %s.`},
			&PromptCard{Prompt: `Hey guys, welcome to Boston Pizza! Would you like to start the night off right with %s?`},
			&PromptCard{Prompt: `Hey guys, welcome to Chili's! Would you like to start the night off right with %s?`},
			&PromptCard{Prompt: `Hey guys, welcome to Sizzler! Would you like to start the night off right with %s?`},
			...
			&PromptCard{Prompt: `In a world ravaged by %s, our only solace is %s.`},
			&PromptCard{Prompt: `In an attempt to reach a wider audience, the National Museum of Australia has opened an interactive exhibit on %s.`},
			...
			&PromptCard{Prompt: `In your Best-Man speech, I'd talk about when we found ourselves %s.`},
			&PromptCard{Prompt: `Instead of coal, Father Christmas now gives the bad children %s.`},
			...
			&PromptCard{Prompt: `It's not %s that puts strain on a relationship, it's %s.`},
			&PromptCard{Prompt: `Just once, I'd like to hear you say "Thanks, Mom. Thanks for %s."`},
			&PromptCard{Prompt: `Just once, I'd like to hear you say "Thanks, Mum. Thanks for %s."`},
			...
			&PromptCard{Prompt: `Mate, do not go in that bathroom. There's %s in there.`},
			...
			&PromptCard{Prompt: `Next on Eurosport: The World Championship of %s.`},
			&PromptCard{Prompt: `Next on Nine's Wide World of Sports: The World Championship of %s.`},
			&PromptCard{Prompt: `Next on Sky Sports: The World Champsion of %s.`},
			&PromptCard{Prompt: `Next on Sky Sports: The World Champsion of %s.`},
			&PromptCard{Prompt: `Next on TSN: The World Series of %s.`},
			...
			&PromptCard{Prompt: `Now at the National Museum of Australia: an interactive exhibit on %s.`},
			&PromptCard{Prompt: `Now at the Natural History Museum: an interactive exhibit on %s.`},
			&PromptCard{Prompt: `Now at the Royal Ontario Museum: an interactive exhibit on %s.`},
			&PromptCard{Prompt: `Now at the Smithsonian: an interactive exhibit on %s.`},
...
Step 3: Profit.`},
			...
			&PromptCard{Prompt: `The neighborhood kid didn't use snow for their snowman, they used %s.`},
			...
			&PromptCard{Prompt: `The Smithsonian Museum of Natural History has just opened an interactive exhibit on %s.`},
...
Not with a bang but with %s.`},
			&PromptCard{Prompt: `This is your pilot speaking. Please prepare for %s.`},
			&PromptCard{Prompt: `This season at Steppenwolf, Samuel Beckett's classic existential play: Waitng for %s.`},
			&PromptCard{Prompt: `This season at the old Vic, Samuel Beckett's classic existential play: Waitng for %s.`},
			&PromptCard{Prompt: `This season at the Princess of Wales Theatre, Samuel Beckett's classic existential play: Waiting for %s.`},
			...
			&PromptCard{Prompt: `Today on Maury: "Help! My son is %s!"`},
			&PromptCard{Prompt: `Today on The Jeremy Kyle Show: "Help! My son is %s!"`},
			...
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 20-meter statue to commemorate %s.`},
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 20-metre statue to commemorate %s.`},
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 50-foot statue to commemorate %s.`},
			...
			&PromptCard{Prompt: `When I am Prime Minister of Canada, I will create the Department of %s.`},
			&PromptCard{Prompt: `When I am Prime Minister of Canada, I will create the Ministry of %s.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Department of %s.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Department of %s.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Ministry of %s.`},
			&PromptCard{Prompt: `When I pooped, what came out of my butt?`},
			&PromptCard{Prompt: `When I was tripping on acid, %s turned into %s.`},
			&PromptCard{Prompt: `When I'm pooping, I like to think about %s.`},
