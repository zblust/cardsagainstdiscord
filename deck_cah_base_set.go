...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `_ + _ = Hipsters`},
			&PromptCard{Prompt: `_ is a sure sign of mankind's decline.`},
			&PromptCard{Prompt: `_ would only happen in my worst nightmares.`},
			&PromptCard{Prompt: `_: good to the last drop.`},
			&PromptCard{Prompt: `_: kid tested, mother approved.`},
			&PromptCard{Prompt: `_: kid-tested, mother-approved.`},
			&PromptCard{Prompt: `_: Once you pop, the fun don't stop!`},
			&PromptCard{Prompt: `_? Oh yeah. There's porn about that.`},
			&PromptCard{Prompt: `_? There's an app for that.`},
			&PromptCard{Prompt: `_? Yeah, nah.`},
			&PromptCard{Prompt: `_. Awesome in theory, kind of a mess in practice.`},
			&PromptCard{Prompt: `_. Betcha can't have just one!`},
			&PromptCard{Prompt: `_. High five, bro.`},
			&PromptCard{Prompt: `_. It's a trap!`},
			&PromptCard{Prompt: `_. That was so metal.`},
			&PromptCard{Prompt: `_. That's how I want to die.`},
			&PromptCard{Prompt: `_. The best way to spice up your sex life.`},
			&PromptCard{Prompt: `★✰✰✰✰ Do NOT go here! Found _ in my Kung Pao chicken!`},
			&PromptCard{Prompt: `50% of all marriages end in _.`},
			&PromptCard{Prompt: `A recent laboratory study shows that undergraduates have 50% less sex after being exposed to _.`},
			&PromptCard{Prompt: `A romantic candlelit dinner would be incomplete without _.`},
			&PromptCard{Prompt: `A romantic candlelit dinner would be incomplete without _.`},
			&PromptCard{Prompt: `A romantic, candlelit dinner would be incomplete without _.`},
			&PromptCard{Prompt: `A successful job interview begins with a firm handshake and ends with _.`},
			&PromptCard{Prompt: `ABC presents: "_: The Story of _."`},
			&PromptCard{Prompt: `After eight years in the White House, how is Obama finally letting loose?`},
			&PromptCard{Prompt: `After four platinum albums and three Grammys, it's time to get back to my roots, to what inspired me to make music in the first place: _.`},
			&PromptCard{Prompt: `After Hurricane Katrina, Sean Penn brought _ to all the people of New Orleans.`},
			&PromptCard{Prompt: `After Hurricane Katrina, Sean Penn brought _ to the people of New Orleans.`},
			&PromptCard{Prompt: `After months of practice with _, I think I'm finally ready for _.`},
			&PromptCard{Prompt: `After the earthquake, Sean Penn brought _ to the people of Haiti.`},
			&PromptCard{Prompt: `Air Canada guidelines now prohibit _ on airplanes.`},
			&PromptCard{Prompt: `Airport security guidelines now prohibit _ on airplanes.`},
			&PromptCard{Prompt: `Alternative medicine is now embracing the curative powers of _.`},
			&PromptCard{Prompt: `And the Academy Award for _ goes to _.`},
			&PromptCard{Prompt: `And the BAFTA for _ goes to _.`},
			&PromptCard{Prompt: `And what did you bring for show and tell?`},
			&PromptCard{Prompt: `Anthropologists have recently discovered a primitive tribe that worships _.`},
			&PromptCard{Prompt: `Arby's: We Have _.`},
			&PromptCard{Prompt: `Are you thinking what I'm thinking, B1?

I think I am, B2: it's _ time!`},
			&PromptCard{Prompt: `As my New Year's resolution, I vow to give up _.`},
			&PromptCard{Prompt: `As the mom of five rambunctious boys, I'm no stranger to _.`},
			&PromptCard{Prompt: `As the mum of five rambunctious boys, I'm no stranger to _.`},
			&PromptCard{Prompt: `Betcha can't have just one!`},
			&PromptCard{Prompt: `BILLY MAYS HERE FOR _.`},
			&PromptCard{Prompt: `Bravo's new reality show features eight washed-up celebrities living with _.`},
			&PromptCard{Prompt: `Brought to you by Bud Light®, the Official Beer of _.`},
			&PromptCard{Prompt: `Brought to you by Molson Canadian, the Official Beer of _.`},
			&PromptCard{Prompt: `Brought to you by XXXX Gold, the Official Beer of _.`},
			&PromptCard{Prompt: `But before I kill you, Mr. Bond, I must show you _.`},
			&PromptCard{Prompt: `CBC presents "_: the Story of _."`},
			&PromptCard{Prompt: `Channel 4 presents _, the story of _.`},
			&PromptCard{Prompt: `Channel 5's new reality show features eight washed-up celebrities living with _.`},
			&PromptCard{Prompt: `Channel 9 is pleased to present its new variety show, "Hey Hey It's _."`},
			&PromptCard{Prompt: `Charlie and the chocolate _.`},
			&PromptCard{Prompt: `Check me out, yo! I call this dance move "_."`},
			&PromptCard{Prompt: `Click Here for _!!!`},
			&PromptCard{Prompt: `Coming this season, Samuel Beckett's classic existential play: Waiting for _.`},
			&PromptCard{Prompt: `Coming to Broadway this season, _: The Musical.`},
			&PromptCard{Prompt: `Coming to theaters this holiday season, "Star Wars: The Rise of _."`},
			&PromptCard{Prompt: `Crikey! I've never seen _ like this before! Let's get a bit closer.`},
			&PromptCard{Prompt: `CTV presents "_: the Story of _."`},
			&PromptCard{Prompt: `Daddy, why is mommy crying?`},
			&PromptCard{Prompt: `Daddy, why is mummy crying?`},
			&PromptCard{Prompt: `Dear Abby, I'm having some trouble with _ and would like your advice.`},
			&PromptCard{Prompt: `Dear Agony Aunt, I'm having some trouble with _ and I need your advice.`},
			&PromptCard{Prompt: `Dear Sir or Madam, We regret to inform you that the Office of _ has denied your request for _.`},
			&PromptCard{Prompt: `Doctor, you've gone too far! The human body wasn't meant to withstand that amount of _!`},
			&PromptCard{Prompt: `Dude, do not go in that bathroom. There's _ in there.`},
			&PromptCard{Prompt: `Dude, do not go in that washroom. There's _ in there.`},
			&PromptCard{Prompt: `Due to a PR fiasco, Walmart no longer offers _.`},
			...
			&PromptCard{Prompt: `During Picasso's often-overlooked Brown Period, he produced hundreds of paintings of _.`},
			&PromptCard{Prompt: `During sex, I like to think about _.`},
			&PromptCard{Prompt: `Finally! A service that delivers _ right to your door.`},
			&PromptCard{Prompt: `For my turn, I will spend four gold and allocate all three workers to _.`},
			&PromptCard{Prompt: `Fun tip! When your man asks you to go down on him, try surprising him with _ instead.`},
			&PromptCard{Prompt: `Future historians will agree that _ marked the beginning of America's decline.`},
			&PromptCard{Prompt: `Having problems with _? Try _!`},
			&PromptCard{Prompt: `Here is the church
Here is the steeple
Open the doors
And there is _.`},
			&PromptCard{Prompt: `Hey guys, welcome to Boston Pizza! Would you like to start the night off right with _?`},
			&PromptCard{Prompt: `Hey guys, welcome to Chili's! Would you like to start the night off right with _?`},
			&PromptCard{Prompt: `Hey guys, welcome to Sizzler! Would you like to start the night off right with _?`},
			&PromptCard{Prompt: `Hey guys, welcome to TGIF! Would you like to start the night off right with _?`},
			&PromptCard{Prompt: `Hey Reddit! I'm _. Ask me anything.`},
			&PromptCard{Prompt: `How am I maintaining my relationship status?`},
			&PromptCard{Prompt: `How did I lose my virginity?`},
			&PromptCard{Prompt: `I do not know with what weapons World War III will be fought, but World War IV will be fought with _.`},
			&PromptCard{Prompt: `I drink to forget _.`},
			&PromptCard{Prompt: `I get by with a little help from _.`},
			&PromptCard{Prompt: `I got 99 problems, but _ ain't one.`},
			&PromptCard{Prompt: `I know when that hotline bling, that can only mean one thing: _.`},
			&PromptCard{Prompt: `I learned the hard way that you can't cheer up a grieving friend with _.`},
			&PromptCard{Prompt: `I never truly understood _ until I encountered _.`},
			&PromptCard{Prompt: `I spy with my little eye _.`},
			&PromptCard{Prompt: `I wish I hadn't lost the instruction manual for _.`},
			&PromptCard{Prompt: `I'm going on a cleanse this week. Nothing but kale juice and _.`},
			&PromptCard{Prompt: `I'm Lebron James, and when I'm not slamming dunks, I love _.`},
			&PromptCard{Prompt: `I'm no doctor, but I'm pretty sure what you're suffering from is called "_."`},
			&PromptCard{Prompt: `I'm sorry, Professor, but I couldn't complete my homework because of _.`},
			&PromptCard{Prompt: `I'm sorry, Sir, but I couldn't complete my homework because of _.`},
			&PromptCard{Prompt: `I'm not like the rest of you. I'm too rich and busy for _.`},
			&PromptCard{Prompt: `If you can't be with the one you love, love _.`},
			&PromptCard{Prompt: `IF you like _, YOU MIGHT BE A REDNECK.`},
			&PromptCard{Prompt: `In 1,000 years, when paper money is a distant memory, how will we pay for goods and services?`},
			&PromptCard{Prompt: `In 1,000 years, when paper money is but a distant memory, _ will be our currency.`},
			&PromptCard{Prompt: `In a world ravaged by _ our only solace is _.`},
			&PromptCard{Prompt: `In a world ravaged by _, our only solace is _.`},
			&PromptCard{Prompt: `In an attempt to reach a wider audience, the National Museum of Australia has opened an interactive exhibit on _.`},
			&PromptCard{Prompt: `In an attempt to reach a wider audience, the Smithsonian Museum of Natural History has opened an interactive exhibit on _.`},
			&PromptCard{Prompt: `In Australia, _ is twice as big and twice as deadly.`},
			&PromptCard{Prompt: `In Belmarsh Prison, word is you can trade 200 cigarettes for _.`},
			&PromptCard{Prompt: `In her latest feature-length film, Tracy Beaker struggles with _ for the first time.`},
			&PromptCard{Prompt: `In his new self-produced album, Kanye West raps over the sounds of _.`},
			&PromptCard{Prompt: `In his new summer comedy, Rob Schneider is _ trapped in the body of _.`},
			&PromptCard{Prompt: `In L.A. County Jail, word is you can trade 200 cigarettes for _.`},
			&PromptCard{Prompt: `In M. Night Shyamalan's new movie, Bruce Willis discovers that _ had really been _ all along.`},
			&PromptCard{Prompt: `In Michael Jackson's final moments, he thought about _.`},
			&PromptCard{Prompt: `In Rome, there are whisperings that the Vatican has a secret room devoted to _.`},
			&PromptCard{Prompt: `In the new Disney Channel Original Movie, Hannah Montana struggles with _ for the first time.`},
			&PromptCard{Prompt: `In the seventh circle of Hell, sinners must endure _ for all eternity.`},
			&PromptCard{Prompt: `In your Best-Man speech, I'd talk about when we found ourselves _.`},
			&PromptCard{Prompt: `Instead of coal, Father Christmas now gives the bad children _.`},
			&PromptCard{Prompt: `Instead of coal, Santa now gives the bad children _.`},
			&PromptCard{Prompt: `Introducing the amazing superhero/sidekick duo! It's _ and _!`},
			&PromptCard{Prompt: `Introducing X-Treme Baseball! It's like baseball, but with _!`},
			&PromptCard{Prompt: `It's a trap!`},
			&PromptCard{Prompt: `It's not _ that puts strain on a relationship, it's _.`},
			&PromptCard{Prompt: `Just once, I'd like to hear you say "Thanks, Mom. Thanks for _."`},
			&PromptCard{Prompt: `Just once, I'd like to hear you say "Thanks, Mum. Thanks for _."`},
			&PromptCard{Prompt: `Just saw this upsetting video! Please retweet!! #stop_`},
			&PromptCard{Prompt: `Kids, I don't need drugs to get high. I'm high on _.`},
			&PromptCard{Prompt: `Life for Aboriginal people was forever changed when the white man introduced them to _.`},
			&PromptCard{Prompt: `Life for American Indians was forever changed when the White Man introduced them to _.`},
			&PromptCard{Prompt: `Life was difficult for cavemen before _.`},
			&PromptCard{Prompt: `Lifetime® presents _: the Story of _.`},
			&PromptCard{Prompt: `Lifetime® presents "_: the Story of _."`},
			&PromptCard{Prompt: `Lovin' you is easy 'cause you're _.`},
			&PromptCard{Prompt: `Major League Baseball has banned _ for giving players an unfair advantage.`},
			&PromptCard{Prompt: `Make a haiku.`},
			&PromptCard{Prompt: `Mate, do not go in that bathroom. There's _ in there.`},
			&PromptCard{Prompt: `Mate, do not go in that toilet. There's _ in there.`},
			&PromptCard{Prompt: `Maybe she's born with it. Maybe it's _.`},
			&PromptCard{Prompt: `Men's Wearhouse: You're gonna like _. I guarantee it.`},
			&PromptCard{Prompt: `Military historians remember Alexander the Great for his brilliant use of _ against the Persians.`},
			&PromptCard{Prompt: `Money can't buy me love, but it can buy me _.`},
			&PromptCard{Prompt: `Mr. and Mrs. Diaz, we called you in because we're concerned about Cynthia. Are you aware that your daughter is _?`},
			&PromptCard{Prompt: `MTV's new reality show features eight washed-up celebrities living with _.`},
			&PromptCard{Prompt: `My fellow Americans: Before this decade is out, we will have _ on the moon!`},
			&PromptCard{Prompt: `My mom is so happy when I visit, but I'm only there to be _.`},
			&PromptCard{Prompt: `My plan for world domination begins with _.`},
			&PromptCard{Prompt: `Next from J.K. Rowling: Harry Potter and the Chamber of _.`},
			&PromptCard{Prompt: `Next from J.K. Rowling: Harry Potter and the chamber of _.`},
			&PromptCard{Prompt: `Next on ESPN2: The World Series of _.`},
			&PromptCard{Prompt: `Next on Eurosport: The World Championship of _.`},
			&PromptCard{Prompt: `Next on Nine's Wide World of Sports: The World Championship of _.`},
			&PromptCard{Prompt: `Next on Sky Sports: The World Champsion of _.`},
			&PromptCard{Prompt: `Next on Sky Sports: The World Champsion of _.`},
			&PromptCard{Prompt: `Next on TSN: The World Series of _.`},
			&PromptCard{Prompt: `Next up on Channel 4: Ramsay's _ Nightmares.`},
			&PromptCard{Prompt: `Nobody expects the Spanish Inquisition. Our chief weapons are fear, surprise, and _.`},
			&PromptCard{Prompt: `Now at the National Museum of Australia: an interactive exhibit on _.`},
			&PromptCard{Prompt: `Now at the Natural History Museum: an interactive exhibit on _.`},
			&PromptCard{Prompt: `Now at the Royal Ontario Museum: an interactive exhibit on _.`},
			&PromptCard{Prompt: `Now at the Smithsonian: an interactive exhibit on _.`},
			&PromptCard{Prompt: `O Canada, we stand on guard for _.`},
			&PromptCard{Prompt: `Oi! Show us _!`},
			&PromptCard{Prompt: `Old MacDonald had _. E-I-E-I-O.`},
			&PromptCard{Prompt: `Only you can prevent _.`},
			&PromptCard{Prompt: `Penalty! _: that's 5 minutes in the box!`},
			&PromptCard{Prompt: `Qantas now prohibits _ on airplanes.`},
			&PromptCard{Prompt: `Rumor has it that Vladimir Putin's favorite dish is _ stuffed with _.`},
			&PromptCard{Prompt: `Science will never explain _.`},
			&PromptCard{Prompt: `Skidamarink a dink a dink, skidamarink a doo, I love _.`},
			&PromptCard{Prompt: `Sorry everyone, I just _.`},
			&PromptCard{Prompt: `Step 1: _.
Step 2: _.
Step 3: Profit.`},
			&PromptCard{Prompt: `Studies show that lab rats navigate mazes 50% faster after being exposed to _.`},
			&PromptCard{Prompt: `Thank God for alcohol and _.`},
			&PromptCard{Prompt: `That's right, I killed _. How, you ask? _.`},
			&PromptCard{Prompt: `The blind date was going horribly until we discovered our shared interest in _.`},
			&PromptCard{Prompt: `The class field trip was completely ruined by _.`},
			...
			&PromptCard{Prompt: `The neighborhood kid didn't use snow for their snowman, they used _.`},
			&PromptCard{Prompt: `The new Chevy Tahoe. With the power and space to take _ everywhere you go.`},
			&PromptCard{Prompt: `The school excursion was completely ruined by _.`},
			&PromptCard{Prompt: `The school field trip was completely ruined by _.`},
			&PromptCard{Prompt: `The school trip was completely ruined by _.`},
			&PromptCard{Prompt: `The secret to a lasting marriage is communication, communication, and _.`},
			&PromptCard{Prompt: `The Smithsonian Museum of Natural History has just opened an interactive exhibit on _.`},
			&PromptCard{Prompt: `The TFL apologizes for the delay in train service due to _.`},
			&PromptCard{Prompt: `The theme for next year's Eurovision Song Contest is "We are _."`},
			&PromptCard{Prompt: `The U.S. has begun airdropping _ to the children of Afghanistan.`},
			&PromptCard{Prompt: `They said we were crazy. They said we couldn't put _ inside of _. They were wrong.`},
...
Not with a bang but with _.`},
			...
			&PromptCard{Prompt: `This season at Steppenwolf, Samuel Beckett's classic existential play: Waitng for _.`},
			&PromptCard{Prompt: `This season at the old Vic, Samuel Beckett's classic existential play: Waitng for _.`},
			&PromptCard{Prompt: `This season at the Princess of Wales Theatre, Samuel Beckett's classic existential play: Waiting for _.`},
			&PromptCard{Prompt: `This season at the Sydney Opera House, Samuel Beckett's classic existential play: Waiting for _.`},
			&PromptCard{Prompt: `Today on Jerry Springer: "Help! My son is _!"`},
			&PromptCard{Prompt: `Today on Maury: "Help! My son is _!"`},
			&PromptCard{Prompt: `Today on The Jeremy Kyle Show: "Help! My son is _!"`},
			&PromptCard{Prompt: `Tonight's top story: What you don't know about _ could kill you.`},
			&PromptCard{Prompt: `TSA guidelines now prohibit _ on airplanes.`},
			&PromptCard{Prompt: `Turns out that _-Man was neither the hero we needed nor wanted.`},
			&PromptCard{Prompt: `Uh, hey guys, I know this was my idea, but I'm having serious doubts about _.`},
			&PromptCard{Prompt: `UKIP: Putting _ First!`},
			...
			&PromptCard{Prompt: `When all else fails, I can always masturbate to _.`},
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 20-meter statue to commemorate _.`},
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 20-metre statue to commemorate _.`},
			&PromptCard{Prompt: `When I am a billionare, I shall erect a 50-foot statue to commemorate _.`},
			&PromptCard{Prompt: `When I am President of the United States, I will create the Department of _.`},
			&PromptCard{Prompt: `When I am President, I will create the Department of _.`},
			&PromptCard{Prompt: `When I am Prime Minister of Canada, I will create the Department of _.`},
			&PromptCard{Prompt: `When I am Prime Minister of Canada, I will create the Ministry of _.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Department of _.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Department of _.`},
			&PromptCard{Prompt: `When I am Prime Minister, I will create the Ministry of _.`},
			&PromptCard{Prompt: `When I pooped, what came out of my butt?`},
			&PromptCard{Prompt: `When I was tripping on acid, _ turned into _.`},
			&PromptCard{Prompt: `When I'm pooping, I like to think about _.`},
			&PromptCard{Prompt: `When Pharaoh remained unmoved, Moses called down a Plague of _.`},
			&PromptCard{Prompt: `When you get right down to it, _ is just _.`},
			&PromptCard{Prompt: `While the United States raced the Soviet Union to the moon, the Mexican government funneled millions of pesos into research on _.`},
			&PromptCard{Prompt: `White people like _.`},
			...
			&PromptCard{Prompt: `With enough time and pressure, _ will turn into _.`},
