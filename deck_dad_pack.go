...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `FW: re:\nFBI WARNING!!! VIOLENT GANGS USING %s TO RECRUIT CHILDREN!`},
			&PromptCard{Prompt: `Hey, kids.\nI'm Connor's dad, but you can call me Mr. %s.`},
			&PromptCard{Prompt: `So apparently Dad was searching Pornhub for "hot milf %s."`},
			&PromptCard{Prompt: `Whaddya think, money grows on trees? I'm not paying for %s!`},
			&PromptCard{Prompt: `Young lady, you better knock it off with %s or you're grounded!`},
		},
