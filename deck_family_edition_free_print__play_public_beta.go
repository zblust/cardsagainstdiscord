...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `_? No.`},
			&PromptCard{Prompt: `Alright, which one of you little terds is responsible for _?!`},
			&PromptCard{Prompt: `At school, I'm just Mandy. But at summer camp, I'm "_ Mandy."`},
			&PromptCard{Prompt: `Attention students. This is Principal Butthead. Please remember that we do not alow _ in the hallway. Thank you.`},
			&PromptCard{Prompt: `Beep beep! _ coming through!`},
			&PromptCard{Prompt: `Before I attend your sleepover, I must inform you: toys vore me, and I don't care for sweets. I prefer _.`},
			&PromptCard{Prompt: `Bow before me, for I am the Queen of _!`},
			&PromptCard{Prompt: `Boys? No. _? Yes!`},
			&PromptCard{Prompt: `CHUNGO FEEL SICK. CHUNGO NO LIKE _ ANYMORE.`},
			&PromptCard{Prompt: `Class, pay close attention. I will now demonstrate the physics of _.`},
			&PromptCard{Prompt: `Come on, Danny. All the cool kids are doin' it. Wanna try _?`},
			&PromptCard{Prompt: `Come with me, and I will show you a world of _.`},
			&PromptCard{Prompt: `Coming soon! Batman vs. _.`},
			&PromptCard{Prompt: `Coming to theaters this holiday season, "Star Wars: The Rise of _."`},
			&PromptCard{Prompt: `Did you know that Benjamin Franklin invented _?`},
			&PromptCard{Prompt: `ENOUGH! I will not let _ tear this family apart!`},
			&PromptCard{Prompt: `Ew. Grandpa smells like _.`},
			&PromptCard{Prompt: `Foolish child! Did you think you could escape from _?`},
			&PromptCard{Prompt: `Guys, stop it! There's nothing funny about _.`},
			&PromptCard{Prompt: `Hey guys. I just want to tell all my followers who are struggling wit _: it DOES get better.`},
			&PromptCard{Prompt: `Hey, check out my band! We're called "Rage Against _."`},
			&PromptCard{Prompt: `Hey, kids. I'm Sensei Todd. Today, I'm gonna teach you how to defend yourself against _.`},
			&PromptCard{Prompt: `Huddle up, Wildcats! They may be bigger. They may be faster. But we've got a secret weapon: _.`},
			&PromptCard{Prompt: `I don't really know what my mom's job is, but I think it has something to do with _.`},
			&PromptCard{Prompt: `I have invented a new sport. I call it "_ ball."`},
			&PromptCard{Prompt: `I lost my arm in a _ accident.`},
			&PromptCard{Prompt: `Isn't this great, honey? Just you, me, the kids, and _.`},
			&PromptCard{Prompt: `It's BIG.
It's SCARY.
It's _!`},
			&PromptCard{Prompt: `James Bond will return in "No Time for _."`},
			&PromptCard{Prompt: `Joey, look out behind you! It's _!`},
			&PromptCard{Prompt: `Kids, Dad is trying something new this week. It's called "_".`},
			&PromptCard{Prompt: `Ladies and gentlemen, I have discovered something amazing. I have discovered _.`},
			&PromptCard{Prompt: `Madam President, we've run out of time. The only option is _.`},
			&PromptCard{Prompt: `Me and my friends don't play with dolls anymore. We're into _ now.`},
			&PromptCard{Prompt: `ME HUNGRY. ME WANT _.`},
			&PromptCard{Prompt: `Mom? You have to come pick me up! There's _ at this party.`},
			&PromptCard{Prompt: `Moms love _.`},
			&PromptCard{Prompt: `My dad and I enjoy _ together.`},
			&PromptCard{Prompt: `My favorite book is "The Amazing Adventures of _."`},
			&PromptCard{Prompt: `MY NAME IS CHUNGO. CHUNGO LOVE _.`},
			&PromptCard{Prompt: `My name is Peter Parker. I was bitten by a radioactive spider, and now I'm _.`},
			&PromptCard{Prompt: `Never fear, Captain _ is here!`},
			&PromptCard{Prompt: `New from Mattel! It's BUNGO: The Game of _."`},
			...
			&PromptCard{Prompt: `Oh Dark Lord, we show out devotion with a humble offering of _!`},
			&PromptCard{Prompt: `Oh, no thank you, Mrs. Lee. I've had plenty of _ for now.`},
			&PromptCard{Prompt: `One nation, under God, indivisible, with liberty and _ for all.`},
			&PromptCard{Prompt: `Outback Steakhouse: No rules. Just _.`},
			&PromptCard{Prompt: `Police! Arrest this man! He's _!`},
			&PromptCard{Prompt: `Run, run, as fast as you can. You can't catch me, I'm _!`},
			&PromptCard{Prompt: `Shut up, Becky! At least I'm not _.`},
			&PromptCard{Prompt: `Thanks for watching! IF you want to seee more vids of _, smash that subscribe.`},
			&PromptCard{Prompt: `The easiest way to tell me and my twin apart is that I have a freckle on my cheek and she's _.`},
			&PromptCard{Prompt: `The warm August air was filled with change. Things were different, for Emily was now _.`},
			&PromptCard{Prompt: `There's nothing better than a peanut butter and _ sandwich.`},
			&PromptCard{Prompt: `They call me "Mr. _."`},
			&PromptCard{Prompt: `This is gonna be the best sleepover ever. Once Mom and Dad go to bed, it's time for _!`},
			&PromptCard{Prompt: `Time to put on my favorite t-shirt, the one that says "I heart _."`},
			&PromptCard{Prompt: `Today we honor St. Mungo, the patron saint of _.`},
			&PromptCard{Prompt: `We're off to see the wizard, the wonderful wizard of _!`},
			...
			&PromptCard{Prompt: `Where in the world is _?`},
			&PromptCard{Prompt: `Whoa there, partner! Looks like _ spooked my horse.`},
			&PromptCard{Prompt: `You don't love me, Sam. All you care about is _.`},
		},
