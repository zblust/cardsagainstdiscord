...
func init() {
	pack := &CardPack{
		Name:        "Fantasy Pack",
		Description: "Fantasy Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `And in the end, the dragon was not evil; he just wanted _.`},
			&PromptCard{Prompt: `Critics are raving about HBO's new Game of Thrones spin-off, "_ of _."`},
			&PromptCard{Prompt: `Having tired of poetry and music, the immortal elves now fill their days with _.`},
			&PromptCard{Prompt: `Legend tells of a princess who has been asleep for a thousand years and can only be awoken by _.`},
			...
			&PromptCard{Prompt: `Your father was a powerful wizard, Harry. Before he died, he left you something very precious: _.`},
		},
