...
func init() {
	pack := &CardPack{
		Name:        "Food Pack",
		Description: "Food Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `Aw babe, your burbs smell like _.`},
			&PromptCard{Prompt: `Don't fear failure fear _`},
			&PromptCard{Prompt: `Excuse me, waiter. Could you take this back? This soup tastes like _.`},
			&PromptCard{Prompt: `I'm Bobby Flay, and if you can't stand _. get out of the kitchen!`},
			&PromptCard{Prompt: `It's not delivery. It's _.`},
