...
pack := &CardPack{
Name:        "greenbox",
Description: "CAH: Green Box Expansion",
Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `Coming to Red LobsterÂ® this month, %s.`},
...
Barack Obama %s.`},
		...
		Responses: []ResponseCard{
			...
			`Fucking me good and taking me to Red Lobster.Â®`,
