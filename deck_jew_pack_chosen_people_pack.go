...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `Can't you see? The Jews are behind everything-the banks, the media, even %s!`},
			&PromptCard{Prompt: `Coming to Broadway next season: "%s on the Roof."`},
			&PromptCard{Prompt: `Oh, your daughter should meet my son! He gives to charity, he loves %s and did I mention he's a doctor?`},
			&PromptCard{Prompt: `What's so important right now that you can't call your mother? %s`},
		},
