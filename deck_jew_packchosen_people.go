...
func init() {
	pack := &CardPack{
		...
		Description: "Jew Pack/Chosen People Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `According to Freud, all children progress through three stages of development: the oral stage, the anal stage, and the _ stage.`},
			&PromptCard{Prompt: `Can't you see? The Jews are behind everything-the banks, the media, even _!`},
			&PromptCard{Prompt: `Coming to Broadway next season: "_ on the Roof."`},
			&PromptCard{Prompt: `Oh, your daughter should meet my son! He gives to charity, he loves _ and did I mention he's a doctor?`},
			&PromptCard{Prompt: `What's so important right now that you can't call your mother?`},
		},
