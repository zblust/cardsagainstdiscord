...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `I'm Commander Shepard, and this is my favorite place for %s on the Citadel.`},
			&PromptCard{Prompt: `It turns out the Reapers didn't want to destroy the galaxy. They just wanted %s.`},
			&PromptCard{Prompt: `We were the two best hand-to-hand combatants on the ship. I had reach, but she had %s.`},
		},
