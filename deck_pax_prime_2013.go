...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			...
			&PromptCard{Prompt: `In the new DLC for Mass Effect, Shepard must save the galaxy from %s.`},
			&PromptCard{Prompt: `No Enforcer wants to manage the panel on %s.`},
			&PromptCard{Prompt: `The most controversial game at PAX this year is an 8-bit indie platformer about %s.`},
			&PromptCard{Prompt: `There was a riot at the Gearbox panel when they gave the attendees %s.`},
