...
func init() {
	pack := &CardPack{
		Name:        "Pride Pack",
		Description: "Pride Pack pack",
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `Excuse me, straight man, but _ isn't for you, STRAIGHT MAN.`},
			&PromptCard{Prompt: `GOD HATES _!`},
			&PromptCard{Prompt: `If you can't love yourself, how the hell you gonna love _?`},
			&PromptCard{Prompt: `We're here! We're _! Get used to it!`},
