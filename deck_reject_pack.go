...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `From WBEZ Chicago, it's This American Life. Today on our program, _. Stay with us.`},
			&PromptCard{Prompt: `My name is Inigo Montoya. You killed my father. Prepare for _.`},
			&PromptCard{Prompt: `Sir, we found you passed out naked on the side of the road. What's the last thing you remember?`},
			&PromptCard{Prompt: `The elders of the Ibo tribe of Nigeria recommend _ as a cure for impotence.`},
			&PromptCard{Prompt: `The Westboro Baptist Church is now picketing soldiers' funerals with signs that read 'GOD HATES _!'`},
			...
			&PromptCard{Prompt: `You can't wait forever. It's time to talk to your doctor about _.`},
		},
