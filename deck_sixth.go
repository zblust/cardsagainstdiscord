...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `"This workplace has been 0 days without %s."`},
			&PromptCard{Prompt: `Angelina Jolie will now be special envoy for %s.`},
			&PromptCard{Prompt: `Behind every successful man is %s.`},
			&PromptCard{Prompt: `Come to Toronto for the %s, stay for the %s`},
			&PromptCard{Prompt: `Don't worry, %s is not as hard as it seems.`},
			&PromptCard{Prompt: `Everyday has 86,400 seconds. And I'm always a second away from %s.`},
			&PromptCard{Prompt: `I have an agreement with my significant other, if we meet %s, I am allowed to have sex with them with no consequences.`},
			&PromptCard{Prompt: `I went to the desert and ate of the peyote cactus. Turns out my spirit animal is %s.`},
			&PromptCard{Prompt: `I would be on board with Scientology if it weren't for %s.`},
			&PromptCard{Prompt: `I'm never going to be rich and famous because I'm too busy %s.`},
			&PromptCard{Prompt: `I'm sorry, Professor, but I couldn't complete my homework because of %s.`},
			&PromptCard{Prompt: `If you had to pay me for sex, what would you do first? %s.`},
			...
			&PromptCard{Prompt: `Listen son, your mother and I are getting a divorce, and it's because of %s.`},
			&PromptCard{Prompt: `My grandkids need %s.`},
			&PromptCard{Prompt: `Puff the Magic %s.`},
			&PromptCard{Prompt: `The six things I could never do without: oxygen, facebook, chocolate, netflix, friends, and %s LOL!`},
			&PromptCard{Prompt: `This is an absolutely hilarious video. Please share it! #%s`},
			&PromptCard{Prompt: `To boost morale after Hurricane Harvey, President Trump gave a guy in a pick-up truck %s.`},
			&PromptCard{Prompt: `Tonight's Final Jeopardy category is %s.`},
			&PromptCard{Prompt: `When I was a little girl I always wanted to %s.`},
			&PromptCard{Prompt: `Why would I want %s stuffed down my throat?`},
			&PromptCard{Prompt: `YAAAAAAS! You are serving me %s realness!`},
			&PromptCard{Prompt: `You are under arrest for %s, again!`},
			&PromptCard{Prompt: `You like my cupcakes? I made them myself. The secret ingredient is %s.`},
			&PromptCard{Prompt: `You won't find this in textbooks, but %s is the real reason the US entered World War II.`},
		},
