...
func init() {
	pack := &CardPack{
		...
		Prompts: []*PromptCard{
			&PromptCard{Prompt: `_? Jim'll fix it!`},
			&PromptCard{Prompt: `_. That's why mums go to Iceland.`},
			&PromptCard{Prompt: `_. Once you pop, the fun don't stop!`},
			&PromptCard{Prompt: `And the Lord said, "Let there be _". And it was GOOD.`},
			...
			&PromptCard{Prompt: `Coming to the West End this year, _: The Musical.`},
			&PromptCard{Prompt: `Dear Allah, if I promise to stop _ will you let me into heaven and give me 72 virgins?`},
			&PromptCard{Prompt: `In high school, I was popular with the football team for _.`},
			&PromptCard{Prompt: `In Wormwood Scrubs, word is you can trade 200 cigarettes for _.`},
			&PromptCard{Prompt: `Next on Sky Sports: The World Championship of _.`},
			&PromptCard{Prompt: `Nobody expects the Spanish Inquisition! Our chief weapons are fear, surprise, and _.`},
			&PromptCard{Prompt: `TFL apologizes for the delay in train service due to _.`},
			&PromptCard{Prompt: `The Natural History Museum has just opened an interactive exhibit on _.`},
			&PromptCard{Prompt: `The theme for our senior prom will be _.`},
			...
			&PromptCard{Prompt: `When I am Prime Minister of the United Kingdom, I will create the Ministry of _.`},
		},
