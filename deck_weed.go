...
pack := &CardPack{
Name:        "weed",
Description: "Weed Pack",
Prompts: []*PromptCard{
			&PromptCard{Prompt: `Everyone is staring at you because you're %s.`},
			&PromptCard{Prompt: `Hold up. I gotta deal with %s, then l'mma smoke this.`},
			...
			&PromptCard{Prompt: `Okay here's the pitch. James Franco and Seth Rogen are trying to score some weed, and then %s happens.`},
			&PromptCard{Prompt: `You know what's, like, really funny when you think about it? %s.`},
		},
